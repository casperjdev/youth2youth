...
<template>
	<div class="min-h-screen flex items-center px-2 sm:px-4 md:px-16 py-8 justify-center bgtarget">
		<Card
			additionalClasses="max-w-lg w-full backdrop-blur-sm bg-black/50! text-neutral-950/10! flex flex-col">
			<div class="p-4 sm:p-6 flex flex-col items-center space-y-2 sm:space-y-6">
				<!-- Status Code -->
				<div class="text-center">
					<span class="text-5xl sm:text-6xl text-neutral-50/80 mb-4 sm:mb-6 block emoji">{{
						config.icon
					}}</span>
